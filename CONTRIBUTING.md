...
fork — please [open an issue](https://github.com/ArnasDon/wacrm/issues/new).
Including the commit SHA, the runtime (Vercel / local / other), and
...
- **Security fixes** — always welcome; please report privately first
  (see above) before opening a public PR.
...
- In the PR description, explain the change and how you tested it.

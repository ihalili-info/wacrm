...
//      reverse proxy in front of the app: Vercel, Cloudflare,
//      nginx. This is what makes invite links Just Work in
//      production without forcing the operator to set an env var.
...
//   typical proxied deploy (Vercel / Cloudflare / nginx) the

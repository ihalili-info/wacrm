          ...
          <div className="rounded-lg border border-border bg-muted p-4">
            ...
            <dl className="grid grid-cols-1 gap-3 text-sm sm:grid-cols-2">
              <div>
                ...
                {/* `account_role` (owner / admin / agent / viewer) is the
                    real RBAC role. The legacy `profiles.role` TEXT column
                    from migration 001 always reads "user" and must never
                    be surfaced — it made owners look unprivileged here. */}
